            ...
            <div className="authRight w-[70%] h-[100%] bg-[var(--bg-white)]">
                <div className='content-container w-[90%] h-[100%] mx-auto mt-[1.5rem] mb-[2rem]'>
                    <div className='cta-container w-[100%] h-[10%] flex justify-start items-center'>
                        <Link to={ROUTES.COMMON.INSTAUTH} className='flex items-center gap-[0.5rem] text-[var(--primary-blue)] font-[500] text-[1rem] border border-[var(--primary-blue)] px-[1.5rem] py-[0.75rem] rounded-[0.3rem]'>
                            <IoMdArrowBack />
                            Back
                        </Link>
                    </div>
