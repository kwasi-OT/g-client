                ...
                (
                    <div className=" h-fit flex flex-col items-center justify-center w-full pb-[2rem] px-[0]">
                        ...
                        <div className="flex flex-col gap-[1.5rem]">
                            ...
                            <button className="w-full flex items-center justify-center gap-[0.5rem] bg-[var(--primary-blue)] text-[var(--bg-white)] py-[0.5rem] rounded-[0.3rem]" onClick={toggleResetPassword}>
                                Reset password
