...
const SolutionCard = ({logo, title, description, price}) => {
    return (
        <div className={`flex flex-col items-start justify-center gap-[1rem] shadow-[0px_16px_32px_0px_#00000026] box-border max-w-[30%] h-[100%] rounded-[1rem] py-[0.5rem] px-[2rem]`}>
