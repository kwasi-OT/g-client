...
const AuthModal = ({isVisible}) => {
    ...
    return (
        <div className="fixed top-[14.3%] left-[60%] z-[1] w-[30%] h-fit bg-[var(--bg-white)] mx-auto mt-6 border border-[var(--primary-blue)] rounded-[0.3rem] shadow-lg flex flex-col justify-center items-center">
